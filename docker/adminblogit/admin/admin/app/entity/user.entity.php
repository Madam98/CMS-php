...
class UserEntity extends AuthorizationEntity{
	...
	public function getTypeOfUserId() {
		return $this->type_of_users_id;
	}

	public function setTypeOfUserId(int $type_of_users_id) {
		$this->type_of_users_id = $type_of_users_id;
	}
